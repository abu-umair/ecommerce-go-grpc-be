...
type HelloWorldResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Base          *common.BaseResponse   `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"` //?menambahkan common.BaseResponse
...
const file_service_service_proto_rawDesc = "" +
	...
	"\n" +
	"HelloWorld\x12\x1a.service.HelloWorldRequest\x1a\x1b.service.HelloWorldResponseB6Z4github.com/abu-umair/ecommerce-go-grpc-be/pb/serviceb\x06proto3"
