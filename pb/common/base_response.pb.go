...
type BaseResponse struct {
	...
	ValidationError []*ValidationError     `protobuf:"bytes,4,rep,name=validation_error,json=validationError,proto3" json:"validation_error,omitempty"` //?  repeated = karena bisa lebih dari stu field validasi
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_common_base_response_proto_rawDesc = "" +
	...
	"\x10validation_error\x18\x04 \x03(\v2\x17.common.ValidationErrorR\x0fvalidationErrorB5Z3github.com/abu-umair/ecommerce-go-grpc-be/pb/commonb\x06proto3"
