...
const file_order_order_proto_rawDesc = "" +
	...
	"\x11UpdateOrderStatus\x12\x1f.order.UpdateOrderStatusRequest\x1a .order.UpdateOrderStatusResponseB4Z2github.com/abu-umair/ecommerce-go-grpc-be/pb/orderb\x06proto3"
