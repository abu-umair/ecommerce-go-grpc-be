...
type CreateOrderRequestProductItem struct {
	...
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` //?tidak diisi karena nested
...
type CreateOrderRequest struct {
	...
	Products      []*CreateOrderRequestProductItem `protobuf:"bytes,5,rep,name=products,proto3" json:"products,omitempty"` //?berbentuk nested (array)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_order_order_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x01R\x05price\x12\x1a\n" +
	"\bquantity\x18\x04 \x01(\x03R\bquantity\"\xab\x03\n" +
	...
	"\x05items\x18\v \x03(\v2\x1e.order.DetailOrderResponseItemR\x05items2\xa9\x02\n" +
	"\fOrderService\x12D\n" +
	...
	"\vDetailOrder\x12\x19.order.DetailOrderRequest\x1a\x1a.order.DetailOrderResponseB4Z2github.com/abu-umair/ecommerce-go-grpc-be/pb/orderb\x06proto3"
